...
export default function FileUpload({ onUploadComplete, onProcessingChange, onError }) {
          ...
          <div className="border-3 border-dashed border-slate-400 rounded-2xl p-8 text-center hover:border-emerald-500 hover:bg-emerald-50/50 hover:shadow-md transition-all duration-200">
              <div className="space-y-1">
                ...
                <p className="text-xs text-slate-500 mt-2">
                  Columns required: <span className="font-semibold">sku</span>, <span className="font-semibold">name</span>, <span className="font-semibold">description</span>, optional <span className="font-semibold">is_active</span> (true/false)
                </p>
              </div>
          </div>
        )}
